    ...
    return (
        <section className="flex flex-col lg:flex-row justify-around items-center md:items-start pb-16 px-4 bg-primary w-full h-auto gap-6">
          <div className="md:max-w-3xl text-center relative flex flex-col items-center">
            ...
            <div>
              <span className='text-lg leading-7 text-white md:font-semibold'>Alugue um ambiente exclusivo com espaços para locação, oferecemos a estrutura ideal para você atender seus clientes com conforto e estilo.</span><br/>
