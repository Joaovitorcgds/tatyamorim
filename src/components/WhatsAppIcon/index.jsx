...
export function WhatsAppIcon() {
  return (
    <div className="flex justify-center items-center w-14 h-14 md:w-24 md:h-24 rounded-full fixed z-20 right-2 bottom-2 shadow-2xl bg-[#41c054]animation pulse">
